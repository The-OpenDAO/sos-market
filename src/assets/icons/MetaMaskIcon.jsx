  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M7.804 10.41l-1.19 1.801 4.241.188-.15-4.557-2.9 2.569zM16.188 10.41l-2.937-2.62-.098 4.61 4.233-.19-1.198-1.8zM8.045 18.637l2.546-1.243-2.2-1.718-.346 2.96zM13.401 17.394l2.554 1.243-.354-2.96-2.2 1.717z"
      />
      <path
        fill="#D7C1B3"
        stroke="#D7C1B3"
      ...
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10.456 14.576l-2.125-.625 1.5-.685.625 1.31zM13.537 14.576l.625-1.31 1.506.685-2.131.625z"
      />
      <path
        fill="#CD6116"
        stroke="#CD6116"
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M8.045 18.637l.362-3.059-2.358.068 1.996 2.99zM15.593 15.578l.362 3.059 1.996-2.991-2.358-.068zM17.386 12.21l-4.234.19.392 2.176.625-1.31 1.507.685 1.71-1.74zM8.331 13.951l1.507-.685.618 1.31.399-2.177-4.241-.188 1.717 1.74z"
      />
      <path
        fill="#E4751F"
        stroke="#E4751F"
      ...
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M13.544 14.576l-.504 2.57.361.248 2.2-1.718.075-1.725-2.132.625zM8.331 13.951l.06 1.725 2.2 1.718.362-.249-.497-2.569-2.125-.625z"
      />
      <path
        fill="#C0AD9E"
        stroke="#C0AD9E"
      ...
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M13.4 17.394l-.36-.249h-2.087l-.362.249-.188 1.664.173-.165h2.84l.188.165-.203-1.664z"
      />
      <path
        fill="#763D16"
        stroke="#763D16"
